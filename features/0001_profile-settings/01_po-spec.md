...
- [ ] **AC-6**: The page includes a "Delete Account" button that, when clicked, opens a confirmation modal warning the user that the action is destructive and irreversible.
...
## Open Questions
- Do we require the user to enter their password again inside the "Delete Account" confirmation modal for added security, or is clicking "Confirm" sufficient?
- Are there specific minimum/maximum length or character restrictions for the Display Name?
